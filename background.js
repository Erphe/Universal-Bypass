		...
		xhr.onerror = () => {
			...
			xhr.onload = () => {
				...
				else
				{
					...
					xhr.open("GET", "https://raw.githubusercontent.com/Erphe/Universal-Bypass/" + upstreamCommit + "/injection_script.js", true)
					xhr.send()
					...
					xhr2.open("GET", "https://raw.githubusercontent.com/Erphe/Universal-Bypass/" + upstreamCommit + "/rules.json", true)
					xhr2.send()
				}
			}
			xhr.onerror = () => {
			...
			xhr.open("GET", "https://api.github.com/repos/Erphe/Universal-Bypass/commits/master", true)
			xhr.send()
		}
	}
